...
class StatusPagesIssues(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        title: str,
        components: Union[
            Iterable[models.V4StatusPagesIssuesCreateIssueRequestComponent],
            Iterable[models.V4StatusPagesIssuesCreateIssueRequestComponentTypedDict],
        ],
        issues: Union[
            Iterable[models.V4StatusPagesIssuesCreateIssueRequestIssue],
            Iterable[models.V4StatusPagesIssuesCreateIssueRequestIssueTypedDict],
        ],
    ...
    def get_by_id(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.IssuesGetIssueByIDResponse:
        r"""Get Issue By ID
