...
from squadcast.schedules_export import SchedulesExport
from squadcast.schedules_overrides import SchedulesOverrides
...
class SchedulesSDK(BaseSDK):
    ...
    def list(
        ...
        *,
        team_id: str,
        schedule_i_ds: Optional[Iterable[int]] = None,
        ...
        escalation_policies: Optional[Iterable[str]] = None,
        ...
        request = models.SchedulesListSchedulesRequest(
            team_id=team_id,
            schedule_i_ds=utils.unmarshal(schedule_i_ds, Optional[List[int]]),
            participants=utils.unmarshal(participants, Optional[List[str]]),
            ...
            owner_id=owner_id,
            escalation_policies=utils.unmarshal(
                escalation_policies, Optional[List[str]]
            ),
    ...
    def create(
        ...
        *,
        ...
        time_zone: str,
        tags: Union[Iterable[models.V4Tag], Iterable[models.V4TagTypedDict]],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
