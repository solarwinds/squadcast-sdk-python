...
class Issues(BaseSDK):
    ...
    def update(
        ...
        *,
        ...
        title: str,
        components: Union[
            Iterable[models.V4StatusPagesIssuesUpdateIssueRequestComponent],
            Iterable[models.V4StatusPagesIssuesUpdateIssueRequestComponentTypedDict],
        ],
        issues: Union[
            Iterable[models.V4StatusPagesIssuesUpdateIssueRequestIssue],
            Iterable[models.V4StatusPagesIssuesUpdateIssueRequestIssueTypedDict],
        ],
