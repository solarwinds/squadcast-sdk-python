...
from squadcast.apitoken import APIToken
from squadcast.apitokens import APITokens
...
class Users(BaseSDK):
    ...
    def update_org_level_permissions(
        ...
        *,
        data: Union[
            Iterable[models.V3UsersUpdateUserAbilitiesRequestData],
            Iterable[models.V3UsersUpdateUserAbilitiesRequestDataTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
