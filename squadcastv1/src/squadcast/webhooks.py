...
class Webhooks(BaseSDK):
    def create(
        ...
        *,
        name: str,
        triggers: Union[
            Iterable[models.V3ExtensionsWebhooksWebhookTrigger],
            Iterable[models.V3ExtensionsWebhooksWebhookTriggerTypedDict],
        ],
        urls: Union[
            Iterable[models.V3ExtensionsWebhooksWebhookURL],
            Iterable[models.V3ExtensionsWebhooksWebhookURLTypedDict],
        ],
        trigger_type: str,
        ...
        request = models.V3ExtensionsWebhooksWebhook(
            ...
            max_retry=max_retry,
            teams=utils.unmarshal(teams, OptionalNullable[List[str]]),
            is_all_teams_configured=is_all_teams_configured,
            custom_payload_template_slug=custom_payload_template_slug,
            language=language,
            mail_ids=utils.unmarshal(mail_ids, OptionalNullable[List[str]]),
