...
class SuppressionRules(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                tags=["Services/Suppression Rules"],
                extensions=None,
            ),
            request=req,
    ...
    def create_or_update(
        ...
        *,
        service_id: str,
        rules: Union[
            Iterable[models.V3ServicesSuppressionRulesSuppressionRule],
            Iterable[models.V3ServicesSuppressionRulesSuppressionRuleTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
