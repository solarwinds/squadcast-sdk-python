...
from squadcast.roles import Roles
from squadcast.teams_members import TeamsMembers
...
class Teams(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        request = models.V3TeamsCreateTeamRequest(
            ...
            member_ids=utils.unmarshal(member_ids, List[str]),
        )
    ...
    def update(
        ...
        *,
        team_id: str,
        members: Union[
            Iterable[models.V3TeamsUpdateTeamRequestMember],
            Iterable[models.V3TeamsUpdateTeamRequestMemberTypedDict],
        ],
    ...
    def add_bulk_member(
        ...
        *,
        team_id: str,
        members: Union[
            Iterable[models.V3TeamsAddBulkTeamMemberRequestMember],
            Iterable[models.V3TeamsAddBulkTeamMemberRequestMemberTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
