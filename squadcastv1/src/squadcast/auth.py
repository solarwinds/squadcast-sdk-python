...
class Auth(BaseSDK):
    def auth_get_access_token(
        ...
        *,
    ...
    ) -> models.AuthGetAccessTokenResponse:
        r"""Get Access Token
        ...
        :param x_refresh_token: (Required) Send your refresh token obtained from Squadcast web application.
        ...
        if server_url is not None:
            ...
            base_url = models.AUTH_GET_ACCESS_TOKEN_OP_SERVERS[0]

        request = models.AuthGetAccessTokenRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Auth_getAccessToken",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.AuthGetAccessTokenResponse, http_res)
    ...
    async def auth_get_access_token_async(
        self,
        *,
        x_refresh_token: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
