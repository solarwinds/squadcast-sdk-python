...
from squadcast.falsepositive import FalsePositive
    ...
    def create(
        ...
        *,
        ...
        slo_monitoring_checks: Optional[
            Union[
                Iterable[models.V3SLOSLOMonitoringCheck],
                Iterable[models.V3SLOSLOMonitoringCheckTypedDict],
            ]
        ] = None,
        slo_actions: Optional[
            Union[
                Iterable[models.V3SLOSLOAction],
                Iterable[models.V3SLOSLOActionTypedDict],
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.V3SLOCreateSLORequest(
            ...
            service_ids=utils.unmarshal(service_ids, List[str]),
            slis=utils.unmarshal(slis, List[str]),
