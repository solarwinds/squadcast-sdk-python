...
class StatusPagesSubscribers(BaseSDK):
    def status_pages_delete_subscriber_by_id(
        ...
        *,
    ...
    ) -> models.StatusPagesDeleteSubscriberByIDResponse:
        r"""Delete Subscriber By ID
        ...
        request = models.StatusPagesDeleteSubscriberByIDRequest(
        ...
        req = self._build_request(
            method="DELETE",
            path="/v4/statuspages/{statuspageID}/subscribers/{subscriberID}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="StatusPages_deleteSubscriberById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
                tags=["Status Pages/Subscribers"],
                extensions=None,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.StatusPagesDeleteSubscriberByIDResponse, http_res
            )
