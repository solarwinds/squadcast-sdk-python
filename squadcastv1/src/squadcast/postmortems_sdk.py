...
class PostmortemsSDK(BaseSDK):
    def get_all(
        ...
        *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
        ...
        :param from_date: Provide date in RFC3339 format
        :param to_date: Provide date in RFC3339 format
        :param owner_id: Here owner_id represents team_id
        :param limit:
        ...
        request = models.PostmortemsGetAllPostmortemsRequest(
            from_date=from_date,
            to_date=to_date,
            owner_id=owner_id,
            limit=limit,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.PostmortemsGetAllPostmortemsResponse, http_res
            )
    ...
    def create(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PostmortemsCreatePostmortemResponse:
        r"""Create Postmortem
        ...
        *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
        ...
        request = models.PostmortemsCreatePostmortemRequest(
            incident_id=incident_id,
            v3_incidents_postmortems_create_postmortem_request=models.V3IncidentsPostmortemsCreatePostmortemRequest(
                owner_id=owner_id,
                title=title,
                postmortem=postmortem,
                status=status,
                follow_ups=utils.get_pydantic_model(
                    follow_ups, List[models.V3IncidentsPostmortemsPostmortemFollowUp]
                ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_postmortems_create_postmortem_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.PostmortemsCreatePostmortemResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
