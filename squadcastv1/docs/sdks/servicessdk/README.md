...
with SquadcastSDK(
    ...
    res = squadcast_sdk.services.create(owner_id_param="<id>", name="<value>", owner_id="<id>", escalation_policy_id="<id>")
...
| `owner_id`                                                                                                            | *str*                                                                                                                 | :heavy_check_mark:                                                                                                    | The owner_id is required for POST operations                                                                          |
